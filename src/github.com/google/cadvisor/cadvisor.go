...
// 2017.04.19 newly added paramter.
var containerHousekeepingInterval = flag.Duration("container_housekeeping_interval", 30*time.Second, "interval to allow between container housekeepings")
...
func main() {
	...
	//Newly added - containerHousekeepingInterval time.Duration
	...
	containerManager, err := manager.New(memoryStorage, sysFs, *maxHousekeepingInterval, *allowDynamicHousekeeping, ignoreMetrics.MetricSet, &collectorHttpClient, *containerHousekeepingInterval)
	if err != nil {
